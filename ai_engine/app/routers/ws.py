        ...
        if not existing:
            ...
            if _prev_session_data and _generation_evidence:
                ...
                if _repo_to_clone or _has_cached_ws or _has_real_workspace:
                    ...
                    background_preview_task = asyncio.create_task(background_preview(
                        websocket=websocket,
                        session=session,
                        user_id=user_id,
                        user_jwt=user_jwt,
                        _prev_session_data=_prev_session_data,
                        _bg_conv_id=_bg_conv_id,
                        _platform_repo=_platform_repo,
                        _user_repo=_user_repo,
                        _repo_to_clone=_repo_to_clone,
                        user_package_manager=user_package_manager,
                    ))
