      ...
      <div className="max-w-xl mx-auto">
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
          ...
          <p className="text-sm text-slate-400 text-center max-w-sm mx-auto mb-8 leading-relaxed">
            Link your GitHub or GitLab account so the AI agent can access your
            codebase and submit changes.
          </p>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Select a repo, describe the task, and launch.
            </p>
          </div>
        </div>
              ...
              <div className="mt-3 flex items-start gap-2.5 px-4 py-3 bg-amber-50 border border-amber-200 rounded-xl animate-fade-in">
                ...
                <div>
                  <p className="text-xs font-bold text-amber-700">
                    Warning: Direct commits to Main
                  </p>
                  <p className="text-xs text-amber-600 mt-0.5 leading-relaxed">
                    The AI agent will push commits directly to your{" "}
                    <code className="px-1 py-0.5 bg-amber-100 rounded text-amber-800 font-mono text-[10px]">
                      main
                    </code>{" "}
                    branch. This cannot be undone easily. Consider using a
