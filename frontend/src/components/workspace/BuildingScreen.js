...
const BUILDING_TIPS = [
  { icon: '🔗', text: 'Connect WhatsApp, Calendar, Notion, or Slack by asking the chat' },
  { icon: '🖼️', text: 'Upload a screenshot to show the AI your design inspiration' },
  { icon: '💬', text: 'Use Discussion mode to brainstorm ideas without spending credits' },
  { icon: '⚡', text: 'Ask the AI to add animations, dark mode, or mobile responsiveness' },
  { icon: '🔀', text: 'Your code is pushed to a Git branch after every generation' },
  { icon: '🎨', text: 'Paste a Figma link to let the AI match your exact design spec' },
];
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center relative overflow-hidden bg-white dark:bg-[#0d1117]">
      ...
      <div className="relative z-10 mb-6">
        <div className="absolute -inset-5 rounded-full bg-orange-400/8 dark:bg-orange-400/5 animate-pulse" style={{ animationDuration: '3s' }} />
        <div className="absolute -inset-3 rounded-full bg-orange-400/12 dark:bg-orange-400/8 animate-pulse" style={{ animationDuration: '2.2s', animationDelay: '0.4s' }} />
